...
export class Chat extends React.Component {
  ...
  render() {
    if (this.props.messagesArr) {
      ...
      var messagesList = messages.map(message => {
        ...
        return <div className='chat-record'>
          ...
          <br></br>
          <h6>Recommends #
            <span className='highlight-green'>{message.text}</span>
          </h6>
          <a className='font-white' href={url}>
    ...
    return (<div className='section-wrapper clickObj'>
      <h3 className='font-white chat-description-box'>Welcome to chat.<br/>
        Listening to something soooo good?<br></br>
        Paste a link and get your friends in the mood</h3>
